  ...
  return (
    <div className='flex justify-between'>
      <div className='flex w-24 flex-col items-center rounded-xl bg-[#31C3BD] px-5 py-2 shadow-[inset_0_-4px_0_#1E8E89] md:w-32'>
        <p className='font-bold'>X (YOU)</p>
        <span className='text-xl leading-4 font-semibold'>{scores['X']}</span>
      </div>
      <div className='flex w-24 flex-col items-center rounded-xl bg-[#a8bfc9] px-5 py-1 shadow-[inset_0_-4px_0_#6b8997] md:w-32'>
        ...
        <span className='text-xl leading-4 font-semibold'>{scores['Draw']}</span>
      </div>
      <div className='flex w-24 flex-col items-center rounded-xl bg-[#F2B137] px-5 py-1 shadow-[inset_0_-4px_0_#C48524] md:w-32'>
        <p className='font-bold'>O (AI)</p>
        <span className='text-xl leading-4 font-semibold'>{scores['O']}</span>
      </div>
    </div>
  )
}
